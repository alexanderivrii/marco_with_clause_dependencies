...
class MapSolver(object):
    ...
    def __init__(self, n, bias=True, dump=None, restrict_map=None):
...
class MinicardMapSolver(MapSolver):
    def __init__(self, n, bias=True, rand_seed=None, restrict_map=None):   # bias=True is a high/inclusion/MUS bias; False is a low/exclusion/MSS bias.
...
class MinisatMapSolver(MapSolver):
    def __init__(self, n, bias=True, rand_seed=None, dump=None, restrict_map=None):   # bias=True is a high/inclusion/MUS bias; False is a low/exclusion/MSS bias; None is no bias.
